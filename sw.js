...
self.addEventListener('fetch', evt => {
    ...
    caches.match('https://anchalchouvhan.github.io/pwa-react-app/logo.png').then(alert("Image found")).catch(function(error) {console.log("Error occured while fetching ---"+error)})
